...
;    
;   ----------------------------------------------------------------------
;   File    : JLINK_MONITOR_ISR_ARM.s
;   Purpose : Implementation of debug monitor for J-Link monitor mode
;             debug on Cortex-M devices, supporting ARM compiler.
;   --------  END-OF-HEADER  ---------------------------------------------
...
_APP_SP_OFF_R0              EQU    0x00
_APP_SP_OFF_R1              EQU    0x04
_APP_SP_OFF_R2              EQU    0x08
_APP_SP_OFF_R3              EQU    0x0C
_APP_SP_OFF_R12             EQU    0x10
_APP_SP_OFF_R14_LR          EQU    0x14
_APP_SP_OFF_PC              EQU    0x18
_APP_SP_OFF_XPSR            EQU    0x1C
_APP_SP_OFF_S0              EQU    0x20
_APP_SP_OFF_S1              EQU    0x24
_APP_SP_OFF_S2              EQU    0x28
_APP_SP_OFF_S3              EQU    0x2C
_APP_SP_OFF_S4              EQU    0x30
_APP_SP_OFF_S5              EQU    0x34
_APP_SP_OFF_S6              EQU    0x38
_APP_SP_OFF_S7              EQU    0x3C
_APP_SP_OFF_S8              EQU    0x40
_APP_SP_OFF_S9              EQU    0x44
_APP_SP_OFF_S10             EQU    0x48
_APP_SP_OFF_S11             EQU    0x4C
_APP_SP_OFF_S12             EQU    0x50
_APP_SP_OFF_S13             EQU    0x54
_APP_SP_OFF_S14             EQU    0x58
_APP_SP_OFF_S15             EQU    0x5C
_APP_SP_OFF_FPSCR           EQU    0x60

_NUM_BYTES_BASIC_STACKFRAME    EQU 32
_NUM_BYTES_EXTENDED_STACKFRAME EQU 72

_SYSTEM_DCRDR_OFF            EQU   0x00
_SYSTEM_DEMCR_OFF            EQU   0x04

_SYSTEM_DHCSR               EQU    0xE000EDF0 ; Debug Halting Control and Status Register (DHCSR)
_SYSTEM_DCRSR               EQU    0xE000EDF4 ; Debug Core Register Selector Register (DCRSR)
_SYSTEM_DCRDR               EQU    0xE000EDF8 ; Debug Core Register Data Register (DCRDR)
_SYSTEM_DEMCR               EQU    0xE000EDFC ; Debug Exception and Monitor Control Register (DEMCR)

_SYSTEM_FPCCR              EQU     0xE000EF34 ; Floating-Point Context Control Register (FPCCR)
_SYSTEM_FPCAR              EQU     0xE000EF38 ; Floating-Point Context Address Register (FPCAR)
_SYSTEM_FPDSCR             EQU     0xE000EF3C ; Floating-Point Default Status Control Register (FPDSCR)
_SYSTEM_MVFR0              EQU     0xE000EF40 ; Media and FP Feature Register 0 (MVFR0)
_SYSTEM_MVFR1              EQU     0xE000EF44 ; Media and FP Feature Register 1 (MVFR1)
