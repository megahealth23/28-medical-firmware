...
# Author            : Fan Xu
# FilePath          : \FactoryScriptsc:\workInZG\ZG29\RING\ZG29-svn-main-23-7-17\Firmware\postSES-5ma.py
# LastEditTime      : 2023-07-19 12:03:39
# LastEditors       : Fan Xu2
# Description       : 
...
# 制作DFU文件
os.system(r'cd ../../../scripts/scripts && start app-dfu-zip-SES-5ma.bat %s' % get_app_svn() )
time.sleep(4)
os.system(r'taskkill /f /im cmd.exe')

print(("\"RingV%s-5ma.ZIP\" path: " % get_app_svn()))
