...
float gamma(float x) {
   ...
   */ 
	...
	float y,oup,fact,sum,y2,yi,z,nsum,dsum;
	int swi,n,i;
	
	float spi = 0.9189385332046727417803297;
    float pi  = 3.1415926535897932384626434;
	float xmax = 171.624e+0;
	float xinf = 1.79e308;
	float eps = 2.22e-16;
	float xninf = 1.79e-308;
	
	float num[8] = { -1.71618513886549492533811e+0,
    ...
    float den[8] = { -3.08402300119738975254353e+1,
